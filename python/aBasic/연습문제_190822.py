# 9 객체지향 프로그래밍
#  
# 1.파이썬의 클래스와 객체 지향 프로그래밍에대한 설명으로 틀린 것은?    # 4
# ① 클래스에서 상속은 부모 클래스로부터 속성과 메서드를 물려받은 자식 클래스를 생성하는것을 말한다.
# ② 클래스에서 __init_ _( ) 함수는객체 초기화 예약 함수이다.
...
# 3.다음과 같은 2개의 파일이 있다. ‘main.py’를실행하였을 때 나오는 결과로 알맞은 것은? # 720
...
LG_TV = TV("32", "2019", "LG")
LG_TV.describe()        # LG에서 만든 2019년형 32인치TV
samsung_microwave = Laptop("15", "2018", "Samsung")
samsung_microwave.describe()    # Samsung에서 만든 2018년형 15인치 노트북
